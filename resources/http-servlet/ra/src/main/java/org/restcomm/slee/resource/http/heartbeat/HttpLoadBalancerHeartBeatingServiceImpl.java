...
public class HttpLoadBalancerHeartBeatingServiceImpl
	...
	public static String LB_HB_SERVICE_MBEAN_NAME = "org.restcomm.resources.http-servlet-ra:type=load-balancer-heartbeat-service,name=";
	public final static String LOCAL_HTTP_PORT = "org.restcomm.resources.http-servlet-ra.LOCAL_HTTP_PORT";
	public final static String LOCAL_HTTP_ADDRESS = "org.restcomm.resources.http-servlet-ra.LOCAL_HTTP_ADDRESS";
	public final static String LOCAL_SSL_PORT = "org.restcomm.resources.http-servlet-ra.LOCAL_SSL_PORT";
	...
	protected Map<String, HttpLoadBalancer> register = new ConcurrentHashMap<String, HttpLoadBalancer>();
	...
	protected Set<HttpLoadBalancerHeartBeatingListener> loadBalancerHeartBeatingListeners;
	...
	public HttpLoadBalancerHeartBeatingServiceImpl() {
		loadBalancerHeartBeatingListeners = new CopyOnWriteArraySet<HttpLoadBalancerHeartBeatingListener>();
	}
	...
	public boolean addBalancer(String addr, int rmiPort) {
		...
		HttpLoadBalancer sipLoadBalancer = new HttpLoadBalancer(this, address, rmiPort);
	...
	protected void updateConnectorsAsSIPNode() {
		...
		String httpPortString = stackProperties.getProperty(LOCAL_HTTP_PORT);
		String sslPortString = stackProperties.getProperty(LOCAL_SSL_PORT);
		String ipAddress = stackProperties.getProperty(LOCAL_HTTP_ADDRESS);
		if (ipAddress == null) {
			if (tracer.isFineEnabled()) {
	...
	protected void sendKeepAliveToBalancers() {
		...
		for (HttpLoadBalancer balancerDescription : new HashSet<HttpLoadBalancer>(register.values())) {
			try {
	 ...
	 *         balancer
	 */
	protected ArrayList<SIPNode> getReachableSIPNodeInfo(HttpLoadBalancer balancer, ArrayList<SIPNode> info) {
	...
	public void addLoadBalancerHeartBeatingListener(
			HttpLoadBalancerHeartBeatingListener loadBalancerHeartBeatingListener) {
	...
	public void sendSwitchoverInstruction(HttpLoadBalancer sipLoadBalancer, String fromJvmRoute, String toJvmRoute) {
	...
	public void setGracefulShutdown(HttpLoadBalancer sipLoadBalancer, boolean gracefullyShuttingDown) {
	...
	public void setCustomInfo(HttpLoadBalancer sipLoadBalancer) {
		updateConnectorsAsSIPNode();
	}

	public HttpLoadBalancer[] getLoadBalancers() {
		// This is slow, but it is called rarely, so no prob
		return register.values().toArray(new HttpLoadBalancer[] {});
	}
}
