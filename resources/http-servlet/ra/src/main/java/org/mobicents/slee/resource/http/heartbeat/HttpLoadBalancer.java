...
public class HttpLoadBalancer implements Serializable {
	...
	private transient HttpLoadBalancerHeartBeatingService loadBalancerHeartBeatingService;
	private transient boolean available;
	private transient boolean displayWarning;
	private transient Properties customInfo;

	public HttpLoadBalancer(HttpLoadBalancerHeartBeatingService loadBalancerHeartBeatingService, InetAddress address,
			int rmiPort) {
	...
	public static HttpLoadBalancer getInstanceWithoutRMI(
			HttpLoadBalancerHeartBeatingService loadBalancerHeartBeatingService, InetAddress address,
			SipProvider sipProvider) {
		return new HttpLoadBalancer(loadBalancerHeartBeatingService, address, -1);
	}
	...
	public boolean equals(Object obj) {
		...
		if (super.getClass() != obj.getClass())
			return false;
		HttpLoadBalancer other = (HttpLoadBalancer) obj;
