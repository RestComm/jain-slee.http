...
public class HttpClientNIOResourceAdaptor implements ResourceAdaptor {
	...
	public void setResourceAdaptorContext(ResourceAdaptorContext arg0) {
		...
		tracer = resourceAdaptorContext
				.getTracer(HttpClientNIOResourceAdaptor.class.getSimpleName());
		try {
		...
		try {
			...
			if (tracer.isInfoEnabled()) {
				tracer.info(String.format(
						"HttpClientNIOResourceAdaptor=%s entity activated.",
	 ...
	 * @param activity
	 */
	public void addActivity(HttpClientNIORequestActivityHandle activityHandle,
	...
	public void endActivity(HttpClientNIORequestActivityImpl activity) {
		...
		final HttpClientNIORequestActivityHandle ah = new HttpClientNIORequestActivityHandle(
				activity.getId());
	 ...
	 * @param activity
	 */
	public void processResponseEvent(HttpClientNIOResponseEvent event,
			HttpClientNIORequestActivityImpl activity) {

		HttpClientNIORequestActivityHandle ah = new HttpClientNIORequestActivityHandle(
				activity.getId());
