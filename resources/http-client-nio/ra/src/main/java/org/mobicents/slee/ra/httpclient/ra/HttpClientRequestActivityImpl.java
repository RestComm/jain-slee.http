 ...
 *
 */
public class HttpClientRequestActivityImpl implements HttpClientRequestActivity {
	...
	public HttpClientRequestActivityImpl(HttpClientResourceAdaptor ra) {
		this.ra = ra;
	...
	private FutureCallback<HttpResponse> getFutureCallback(final Object applicationData) {
		return new FutureCallback<HttpResponse>() {		
			public void failed(Exception exception) {
				final HttpClientResponseEventImpl event = new HttpClientResponseEventImpl(null, exception, applicationData);
				ra.processResponseEvent(event, HttpClientRequestActivityImpl.this);
				ra.endActivity(HttpClientRequestActivityImpl.this);				
			}			
			public void completed(HttpResponse response) {
				final HttpClientResponseEventImpl event = new HttpClientResponseEventImpl(response, null, applicationData);
				ra.processResponseEvent(event, HttpClientRequestActivityImpl.this);
				ra.endActivity(HttpClientRequestActivityImpl.this);				
			}			
	...
	public boolean equals(Object obj) {
		if (obj != null && obj.getClass() == this.getClass()) {
			return ((HttpClientRequestActivityImpl) obj).id
					.equals(this.id);
		} else {
			return false;
		}
